...
\captionof{figure}{A time histogram of one of the CH$_3$T injections in our liquid system.  The first red line indicates when CH$_3$T was injected, while the second red line indicated when the purifier was turned on.  Green data points were taken with an analog counter so that deadtime during periods high event rates would not be an issue, while blue data was points are significantly diminished during periods of high event rates due to the nature of our DAQ.}
\end{center}

\begin{center}
\includegraphics[scale=0.5]{Plastic_Purification_Spectra_Overlay.jpg}
\captionof{figure}{An overlay of spectra from the CH$_3$T injection shown in Figure ??.  The blue spectrum was collected prior to injecting CH$_3$T, the red spectrum was collected after injecting CH$_3$T, and the green spectrum was collected after purifying the CH$_3$T away.  In this particular data set we achieved 99.987\% removal of CH$_3$T.}
\end{center}
NOTE TO SELF: UPDATE FIGURE NUMBER


We were able to repeat the injection and purification procedures many times without seeing any rise in the residual background of our system.  Figure ?? illustrates this point.  So far we have injected UPDATE THIS becquerel of activity without seeing any rise in residual background rates.

NOTE TO SELF: UPDATE THIS INFO.. ALSO DOES GAIN CHANGE MATTER IN BACKGROUND RATE? UPDATE FIGURE NUMBER
...
\captionof{figure}{A continuation of the time histogram shown in Figure ??.  The third red line indicates when our purifier was bypassed.}
\end{center}
